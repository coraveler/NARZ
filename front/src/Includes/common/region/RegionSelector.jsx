...
const regions = [
  ...
  { name: '경북', iconSrc: 'https://cdn.builder.io/api/v1/image/assets/TEMP/89f1688d458b4753e153756899f4f01715c0c40b37c918911f5ae667a1bcf562?placeholderIfAbsent=true&apiKey=c7f1d91a917e4e2ba5370da6919a77db' },
  { name: '경남', iconSrc: 'https://cdn.builder.io/api/v1/image/assets/TEMP/30666bbe1eb34ac9a3e93378927e2c165978f1a72b8713d80f588d2d4489ad73?placeholderIfAbsent=true&apiKey=c7f1d91a917e4e2ba5370da6919a77db' },
  { name: '전북', iconSrc: 'https://cdn.builder.io/api/v1/image/assets/TEMP/f5d17f682895f75d04a7514cbbb70f49d719a0f00b02dbfd3cba975ec4281c6b?placeholderIfAbsent=true&apiKey=c7f1d91a917e4e2ba5370da6919a77db' },
  { name: '전남', iconSrc: 'https://cdn.builder.io/api/v1/image/assets/TEMP/b1c805fd219936f991e27eb7834fdd4a4ca694a24af4e8adb661adf140a4cb73?placeholderIfAbsent=true&apiKey=c7f1d91a917e4e2ba5370da6919a77db' },
  { name: '제주', iconSrc: 'https://cdn.builder.io/api/v1/image/assets/TEMP/3cc9192d8821dc5e39f0cce7018755142af75b51c38590a4b82994dab47a58e7?placeholderIfAbsent=true&apiKey=c7f1d91a917e4e2ba5370da6919a77db' },
];
  ...
  return (
    <nav className={styles.container}>
      ...
      {regions.map((region, index) => (
        <RegionItem key={index} iconSrc={region.iconSrc} name={region.name} />
      ))}
    </nav>
  );
};
